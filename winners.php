...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1 data-i18n="hall-title">Hall of Gold</h1>
            <div class="subtitle" data-i18n="hall-subtitle">I cacciatori di tesori di Madness Republic</div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-label" data-i18n="hall-found">Golden Pixel Trovati</div>
        </div>

        <?php if (empty($winners)): ?>
            <div class="empty-state">
                <p data-i18n="hall-empty">Ancora nessun Golden Pixel è stato scoperto...<br>Il prossimo potresti essere tu!
                    🕵️‍♂️</p>
            </div>
        <?php else: ?>
        ...
        <div class="theme-silver" id="silver">
            <h2 data-i18n="hall-silver-title">Hall of Silver</h2>
            <div class="stat-card">
                <div class="stat-number">
                    <?php echo count($winnersSilver); ?>/50
                </div>
                <div class="stat-label" data-i18n="hall-silver-found">Silver Pixel Trovati</div>
            </div>

            <?php if (empty($winnersSilver)): ?>
                <div class="empty-state">
                    <p data-i18n="hall-silver-empty">Nessun Silver Pixel è stato ancora trovato.</p>
                </div>
            <?php else: ?>
                <ul class="winners-list">
    ...
    <script src="../translations.js?v=9"></script>
    <script>
